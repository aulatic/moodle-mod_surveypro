...
/**
 * Strings for component 'surveyprofield_sliders', language 'en'
 *
...
$string['ierr_maximumrequired'] = 'The maximun number of sliderses to select must be lower than {$a}';
$string['ierr_maxrequiredlowerthanminrequired'] = 'Maximum number of sliderses to select can not be lower than minimum';
$string['ierr_minimumrequired'] = 'The minimum number of sliderses to select must be lower than {$a}';
...
$string['maximumrequired_help'] = 'The maximum number of sliderses the user can choose in his/her answer';
$string['maximumrequired'] = 'Maximum allowed options';
$string['minimumrequired_help'] = 'The minimum number of sliderses the user is forced to choose in his/her answer';
...
$string['options_help'] = 'The list of the options for this item. You are allowed to write them as: value::label in order to define value and label both. The label will be displayed close to the corresponding sliders, the value will be stored in the db. If you only specify one word per line (without separator), value and label will both be set to that word. (Take care: the separator "::" is defined in lib.php and can be changed by a developer)';
$string['options'] = 'Options';
$string['parentformat'] = '[One<br>label<br>per<br>line]';
$string['pluginname'] = 'Carey sliders';
$string['restrictions_maximumrequired_more'] = 'No more than {$a} sliderses are allowed';
$string['restrictions_maximumrequired_one'] = 'No more than 1 sliders is allowed';
$string['restrictions_minimumrequired_more'] = 'At least {$a} sliderses have to be selected';
$string['restrictions_minimumrequired_one'] = 'At least 1 sliders has to be selected';
...
$string['userfriendlypluginname'] = 'Carey sliders';
$string['vertical'] = 'vertical';
$string['privacy:metadata'] = 'The "sliders" field plugin does not store any personal data.';

$string['dimension'] = 'Dimensión';
$string['conocimiento'] = 'Conocimiento';
$string['percepcion'] = 'Percepción';
$string['compliance'] = 'Cumplimiento';
$string['idmateria'] = 'ID de Materia';
$string['puntajemin'] = 'Puntaje mínimo';
$string['puntajemax'] = 'Puntaje máximo';
$string['peso'] = 'Peso';