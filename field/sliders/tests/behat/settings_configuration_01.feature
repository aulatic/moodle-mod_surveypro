...
Feature: Submit using sliders item and check form validation (1 of 4)
  ...
  @javascript
  Scenario: Test sliders element using configuration 01
  ...
  @javascript
  Scenario: Test sliders element using configuration 02
