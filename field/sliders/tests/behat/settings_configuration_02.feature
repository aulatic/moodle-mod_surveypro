...
Feature: Submit using sliders item and check form validation (2 of 4)
  ...
  @javascript
  Scenario: Test sliders element using configuration 03
    ...
    And I set the following fields to these values:
      | id_surveypro_field_sliders_1_0        | 1 |
      | id_surveypro_field_sliders_1_noanswer | 1 |
    And I press "Submit"
    And I press "Continue to responses list"
  ...
  @javascript
  Scenario: Test sliders element using configuration 04
    ...
    And I press "New response"
    Then I should see "At least 2 sliderses have to be selected"
    And I set the field "id_surveypro_field_sliders_1_noanswer" to "1"
    And I press "Submit"
    And I press "Continue to responses list"
    Then I should see "3" submissions
