...
Feature: Submit using sliders item and check form validation (4 of 4)
  ...
  @javascript
  Scenario: Test sliders element using configuration 07
  ...
  @javascript
  Scenario: Test sliders element using configuration 08
