 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class surveypromform_textareacarey_plain extends \MoodleQuickForm_textarea {
    ...
    public function getFrozenHtml() {
        ...
        $output .= \html_writer::start_tag('textareacarey', $class);
        $output .= $value;
        $output .= \html_writer::end_tag('textareacarey');
