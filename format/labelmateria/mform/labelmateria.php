 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class surveypromform_labelmateria extends \MoodleQuickForm_static {

    /**
     * Class constructor.
     *
     * @param string $elementName Select name attribute
     * @param mixed $elementLabelmateria Labelmateria(s) for the select
     * @param mixed $options Data to be used to populate options
     * @param mixed $attributes Either a typical HTML attribute string
     *              or an associative array
     */
    public function __construct($elementName=null, $elementLabelmateria=null, $options=null, $attributes=null) {
        parent::__construct($elementName, $elementLabelmateria, $options);
