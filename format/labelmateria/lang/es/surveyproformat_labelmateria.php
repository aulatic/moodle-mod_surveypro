...
/**
 * Strings for component 'surveyproformat_labelmateria', language 'es_mx'
 *
 * @package   surveyproformat_labelmateria
 * @subpackage labelmateria
...
$string['leftlabelmateria'] = 'Etiqueta Materia';
$string['leftlabelmateria_help'] = 'El texto que será mostrado a la izquierda de la etiqueta en el formato';
$string['pluginname'] = 'Etiqueta Materia';
$string['userfriendlypluginname'] = 'Etiqueta Materia';
